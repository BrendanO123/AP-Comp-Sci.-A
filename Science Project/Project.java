...
public class Project{
    ...
    public static void main(String[] args) throws IOException{
        ...
        //asset.RefreshZommReferencesChar();
        ...
        //int green = new Color(34, 139, 34).getRGB();
        //int grey = new Color(128, 128, 128).getRGB();
        for (int x=0; x<scale; x++){
            for (int y=0; y<scale; y++){
                float value=(Noise[x][y] >= 0 ? (Noise[x][y]/max) : (Noise[x][y]-min)/(-min));
                //FractalTest.setRGB(x, y, new Color((int)ComplexNoise2.Lerp(34, 128, value), (int)ComplexNoise2.Lerp(139, 128, value), (int)ComplexNoise2.Lerp(34, 128, value)).getRGB());
